    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <ChangeItem title="Быстрое создание компании в формах">
            <ul className="list-disc list-inside space-y-0.5">
              <li>В полях «Поставщик», «Покупатель» (движение) и «Компания» (расходы) теперь можно <strong>выбрать из списка</strong> или <strong>ввести новую</strong> прямо в форме</li>
              <li>Если компании нет в списке — появится кнопка «Создать» с введённым названием</li>
              <li>Удобно для разовых операций с новыми контрагентами</li>
            </ul>
          </ChangeItem>
          <ChangeItem title="Категория «Транспорт» → «Логистика»">
            <p>Переименована категория расходов для большей точности.</p>
          </ChangeItem>
        </UpdateCard>
