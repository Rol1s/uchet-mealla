    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <ChangeItem title="Расходы — быстрое создание компании">
            <ul className="list-disc list-inside space-y-0.5">
              <li>В поле «Компания» теперь можно <strong>выбрать из списка</strong> или <strong>ввести новую</strong> прямо в форме</li>
              <li>Если компании нет в списке — появится кнопка «Создать» с введённым названием</li>
              <li>Удобно для разовых оплат новым контрагентам</li>
            </ul>
          </ChangeItem>
