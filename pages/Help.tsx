        ...
        <div className="space-y-4 text-sm text-slate-600">
          ...
          <div>
            ...
            <p className="ml-5 mt-1">
              Добавление прихода или расхода: выберите компанию, материал, размер, укажите «Наш товар» или «Товар клиента», вес и дату. 
      ...
      <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <dl className="space-y-3 text-sm">
          <div>
            ...
            <dd className="text-slate-600 ml-4">«Наш товар» — металл принадлежит вам; «Товар клиента» — металл клиента на вашем складе.</dd>
          </div>
          <div>
