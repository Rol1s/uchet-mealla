  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-800">{stats.currentStock.toFixed(3)} т</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-800">{stats.totalIncome.toFixed(3)} т</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-800">{stats.totalExpense.toFixed(3)} т</h3>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 text-white flex flex-col justify-center">
          <h3 className="text-2xl font-bold mb-2">Добро пожаловать в MetalTrack</h3>
